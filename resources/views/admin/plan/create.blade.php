                        ...
                        <div class="row">
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control {{ hasError($errors, 'label') }}" name="label" value="{{ old('label') }}">
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    <label>Giá (USD)</label>
                                    <input type="text" class="form-control {{ hasError($errors, 'price') }}" name="price" value="{{ old('price') }}">
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    <label>Giới hạn bài đăng việc làm</label>
                                    <input type="text" class="form-control {{ hasError($errors, 'job_limit') }}" name="job_limit" value="{{ old('job_limit') }}">
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    <label>Giới hạn bài đăng nổi bật</label>
                                    <input type="text" class="form-control {{ hasError($errors, 'featured_job_limit') }}" name="featured_job_limit" value="{{ old('featured_job_limit') }}">
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    <label>Giới hạn bài đăng được tô sáng</label>
                                    <input type="text" class="form-control {{ hasError($errors, 'highlight_job_limit') }}" name="highlight_job_limit" value="{{ old('highlight_job_limit') }}">
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    <label>Hiển thị trên giao diện người dùng</label>
