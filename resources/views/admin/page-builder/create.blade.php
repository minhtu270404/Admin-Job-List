                ...
                <div class="card-body">
                    <form action="{{ route('admin.page-builder.store') }}" method="POST">
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control {{ hasError($errors, 'page_name') }}" name="page_name" value="{{ old('page_name') }}">
                            <x-input-error :messages="$errors->get('page_name')" class="mt-2" />
                        </div>

                        <div class="form-group">
                            <label for="">Nội dung</label>
                            <textarea name="content" id="editor" class="form-control {{ hasError($errors, 'content') }}"></textarea>
