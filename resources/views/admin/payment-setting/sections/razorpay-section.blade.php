            ...
            <div class="row">
                ...
                <div class="col-md-6">
                    <div class="form-group">
                        ...
                        <select name="razorpay_country_name" class="form-control select2 {{ hasError($errors, 'razorpay_country_name') }}">
                            <option value="">Select</option>
                            @foreach (config('countries') as $key => $country)
                            <option @selected($key === config('gatewaySettings.razorpay_country_name') ) value="{{ $key }}">{{ $country }}</option>
                            @endforeach
                        </select>
                ...
                <div class="col-md-6">
                    <div class="form-group">
                        ...
                        <select name="razorpay_currency_name" class="form-control select2 {{ hasError($errors, 'razorpay_currency_name') }}">
                            <option value="sandbox">Select</option>
                            @foreach (config('currencies.currency_list') as $key => $currency)
                            <option @selected($currency === config('gatewaySettings.razorpay_currency_name') ) value="{{ $currency }}">{{ $currency }}</option>
                            @endforeach
                        </select>
                ...
                <div class="col-md-12">
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control {{ hasError($errors, 'razorpay_currency_rate') }}" name="razorpay_currency_rate"  value="{{ config('gatewaySettings.razorpay_currency_rate') }}">
                ...
                <div class="col-md-12">
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control {{ hasError($errors, 'razorpay_key') }}" name="razorpay_key"  value="{{ config('gatewaySettings.razorpay_key') }}">
                ...
                <div class="col-md-12">
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control {{ hasError($errors, 'razorpay_secret_key') }}" name="razorpay_secret_key" value="{{ config('gatewaySettings.razorpay_secret_key') }}" >
